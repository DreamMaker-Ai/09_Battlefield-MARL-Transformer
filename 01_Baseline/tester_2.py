...
class Tester:
    ...
    def test_play(self, current_weights, epsilon):
        ...
        for _ in range(self.env.config.max_episodes_test_play):
            ...
            while not dones['all_dones']:
                ...
                if dones['all_dones']:
                    ...
                    R0_lsit.append(self.env.config.R0)
                    B0_list.append(self.env.config.B0)
                    winner_list.append(results['winner'])
        ...
        result['R0_list'] = R0_lsit
        result['B0_list'] = B0_list
        result['winner'] = winner_list[0]
